...
var PublishCommand = function (_Command) {
  ...
  _createClass(PublishCommand, [{
    ...
    key: "updateVersionInAsiniJson",
    value: function updateVersionInAsiniJson() {
      this.repository.asiniJson.version = this.masterVersion;
      _FileSystemUtilities2.default.writeFileSync(this.repository.asiniJsonLocation, JSON.stringify(this.repository.asiniJson, null, "  "));
      if (!this.flags.skipGit) {
        _GitUtilities2.default.addFile(this.repository.asiniJsonLocation);
      }
    }
  }, {
    ...
    value: function npmPublishAsPrerelease(callback) {
      ...
      _async2.default.parallelLimit(this.packagesToPublish.map(function (pkg) {
        ...
        var run = function run(cb) {
          ...
          _NpmUtilities2.default.publishTaggedInDir("asini-temp", pkg.location, function (err) {
      ...
      _async2.default.parallelLimit(this.packagesToPublish.map(function (pkg) {
        return function (cb) {
          ...
          while (true) {
            ...
            try {
              if (_NpmUtilities2.default.checkDistTag(pkg.name, "asini-temp")) {
                _NpmUtilities2.default.removeDistTag(pkg.name, "asini-temp");
              }
