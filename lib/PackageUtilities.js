...
var PackageUtilities = function () {
  ...
  _createClass(PackageUtilities, null, [{
    ...
    value: function getPackages(repository) {
      ...
      repository.packageConfigs.forEach(function (_ref) {
        var glob = _ref.glob;


        (0, _glob.sync)(glob).map(function (fn) {
    ...
    key: "getFilteredPackages",
    value: function getFilteredPackages(packages, _ref2) {
